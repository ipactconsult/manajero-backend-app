...
public class EmailSendService {
    ...
    @Autowired
    private LitigeBusiness lb;

    public void sendEmail(String to , String subject , String msg, Litige ord){


        List<Litige> l =lb.findAllLitige();
        ...
        String body = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "      \n" +
                "      <img align=\"center\" border=\"0\" src=\"images/image-3.png\" alt=\"\" title=\"\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 372px;\" width=\"372\"/>\n" +
                "      \n" +
                "    </td>\n" +
                "  </tr>\n" +
                "</table>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 140%;\">Cordialement</p>\n" +
                "<p style=\"font-size: 14px; line-height: 140%;\">Nous avons bien reçu votre demande concernant [objet de la réclamation]," +
                "      Nous sommes sincèrement désolés pour ce désagrément. Nous mettons tout en œuvre\"\n" +
                "            + \"pour résoudre ce problème au plus vite et reviendrons vers vous d’ici le [date] \"\n" +
                "            + \"Merci d’avance de votre patience.\"\n" +
                "            + \"En attendant, permettez-moi de partager avec vous [ressources liées au problème].\"\n" +
                "            + \"Vous y trouverez peut-être des réponses à votre question.</p>\n" +
    ...
    public void sendEmailResolu(String to , String subject , String msg,Litige ord){
  ...
  /*  "Nous avons bien reçu votre demande concernant [objet de la réclamation]"
            + "Nous sommes sincèrement désolés pour ce désagrément. Nous mettons tout en œuvre"
            + "pour résoudre ce problème au plus vite et reviendrons vers vous d’ici le [date] "
            + "Merci d’avance de votre patience."
            + "En attendant, permettez-moi de partager avec vous [ressources liées au problème]."
            + "Vous y trouverez peut-être des réponses à votre question."*/
