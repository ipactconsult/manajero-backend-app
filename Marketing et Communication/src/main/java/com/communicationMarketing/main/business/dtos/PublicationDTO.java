...
public class PublicationDTO {
	...
	public PublicationDTO(String id, String title, String description, String hastag, String content,
			String briefingType, String tags, String socialMedia, Date dateDebut, Date dateFin, String type,
			List<Persona> personas, GraphicalCharter graphicalCharter, boolean archive) {
		super();
		this.id = id;
		this.title = title;
