...
@Document(collection = "Parternership")
public class Parternership {
	...
	public Parternership(String id, String parternershipName, String parternershipLogo, String parternershipDomain,
