...
@Document(collection = "GlobalCharter")
public class GlobalCharter {
	@Id
	String id ; 
	...
	public GlobalCharter(String id, String title, String module, String description, String file, String logo,
