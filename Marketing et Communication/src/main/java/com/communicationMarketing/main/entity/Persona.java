...
public class Persona {
	...
	public Persona(String id, String title, Long age, String localisation, String motivation, String interset,
			...
			boolean archive, String dateofBirth, String frustrations, String personality, String bio, Long phone,
			String languages, long numberOfChildren, String nationality, String adresse) {
		super();
		this.id = id;
		this.title = title;
		this.age = age;
