...
public class RentalRequestServiceImpl implements Iservice<RentalRequest> {
    ...
    final ICompanyService<Company> companyService;
    ...
    public RentalRequest update(RentalRequest entity) {
        String emailToken = restTemplate.getForObject("http://localhost:8070/api/auth/generateToken/" + entity.getEmail(), String.class);
        ...
        String body = "<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\"  style=\"background-color:#171941;\" >\n" +
                ...
                "                                          <a href=\"http://localhost:4200/#/register/" + entity.getEmail() + "/" + emailToken + "/" + entity.getMatriculateFiscal() + "\" style=\"color:#ffffff;\">Read more</a>\n" +
                "                                        </td>\n" +
                "                                        <td width=\"10\"></td>\n" +
                "                                      </tr>\n" +
                "                                    </tbody>\n" +
        ...
        // add company with the rental request details after validation
        RentalRequest request = administrationRepository.findById(entity.getId()).orElse(null);
        assert request != null;
        if (request.getStatus() == Status.APPROVED) {
            Company company = new Company(
                    null,
                    entity.getEmail(),
                    entity.getSecondEmail(),
                    entity.getPhone(),
                    entity.getSecondPhone(),
                    entity.getAddress(),
                    entity.getMatriculateFiscal(),
                    entity.getCompany(),
                    entity.getCountry(),
                    entity.getCity(),
    ...
    @Override
    public RentalRequest findByMatriculate(String matriculate) {
        return administrationRepository.findRentalRequestByMatriculateFiscal(matriculate);
    }
}
